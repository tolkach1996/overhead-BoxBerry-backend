...
class OrdersService {
    ...
    static async updateStatusByDocumenId(id, { type, pickupPoint }) {
        const stateExit = {
            state: {
                meta: {
                    href: "https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata/states/dd8bc731-caef-11e8-9109-f8fc0033f16e",
        ...
        const statePVZ = {
            state: {
                meta: {
                    href: "https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata/states/0b7aae5a-71e9-11ec-0a80-0838010c44a4",
                    metadataHref: "https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata",
                    type: "state",
                    mediaType: "application/json",
                },
        ...
        const pickpointPetrovskoRazumovskaya = {
            state: {
                meta: {
                    href: "https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata/states/ea54ae0d-a656-11ef-0a80-119e000a1175",
                    metadataHref: "https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata",
                    type: "state",
                    mediaType: "application/json",
                },
        ...
        if (type === "accept") {
            state = pickupPoint === "ПВЗ Дубровка" ? statePVZ : pickpointPetrovskoRazumovskaya;
        }
